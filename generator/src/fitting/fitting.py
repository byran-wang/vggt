...
def optimize_batch(
    ...
    model.param_dict["object__global_orient"].requires_grad = False
    model.param_dict["object__transl"].requires_grad = False
    model.param_dict["object__scene_scale"].requires_grad = False
    model.param_dict["right__global_orient"].requires_grad = True
    model.param_dict["right__transl"].requires_grad = True
    model.param_dict["right__scene_scale"].requires_grad = True
