...
def init_dataset(args):
    ...
    print(f"Copied and resized every {k}th frame to {target_dir}, leading to {num_selected} frames.")
    ...
    directories_to_create.append(f'./data/{seq_name}/processed/sam/left')
