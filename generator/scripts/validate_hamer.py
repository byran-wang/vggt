...
def interpolate_hand_pose(seq_name):
    ...
    data_path = f'./data/{seq_name}/hold_fit.init.npy'
    data_2d_path = f'./data/{seq_name}/j2d.full.npy'
    ...
    for hand in data.keys():
        ...
        hand_interp = slerp.slerp_mano_params(outliers, num_frames, key_frames, data[hand])
