...
if __name__ == "__main__":
    ...
    parser.add_argument("--window_size", type=int, default=40, help="Number of frames per sliding window")
    parser.add_argument("--anchor_interval", type=int, default=20, help="Interval between anchor frames")
