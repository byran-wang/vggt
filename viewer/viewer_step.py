...
class ObjDataProvider:
    ...
    def __init__(self, result_dir: Path):
        ...
        self.gen3d_aligned = {
            # "gen3d_mesh": self.base_dir / "../gen_3d_aligned_omni/white_mesh_remesh.obj",
            # "aligned_transform": self.base_dir / "../gen_3d_aligned/refined/aligned_transform.json",
            "gen3d_mesh": self.result_dir / "../gen_3d_aligned_SAM3D/mesh.obj",
            "aligned_transform": self.result_dir / "../gen_3d_aligned_SAM3D/aligned_transform.json",  
        }
